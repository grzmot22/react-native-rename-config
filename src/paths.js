...
export function getFirebasePaths(firebasePath) {
  const originPaths = [
    `${firebasePath}/android/google-services.json`,
    `${firebasePath}/ios/GoogleService-Info.plist`,
  ];
...
export function getIconPaths(iconPath, currentName) {
  const originPaths = [
    ...
    `${iconPath}/android/icon/mipmap-hdpi/bootsplash_logo.png`,
    `${iconPath}/android/icon/mipmap-mdpi/bootsplash_logo.png`,
    `${iconPath}/android/icon/mipmap-xhdpi/bootsplash_logo.png`,
    `${iconPath}/android/icon/mipmap-xxhdpi/bootsplash_logo.png`,
    `${iconPath}/android/icon/mipmap-xxxhdpi/bootsplash_logo.png`,
